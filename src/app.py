...
if __name__ == "__main__":
    ...
    model_path = "src/model/text_classifier.keras"
    vectorizer_path = 'src/model/tfidf_vectorizer.pkl'
    label_encoder_path = 'src/model/label_encoder.pkl'
    category_names_path = 'src/model/category_names.pkl'
